...
<span class="hd_singin">
    ...
    <div class="hd_loginform">
        ...
        <form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
            ...
            <input placeholder="<?=GetMessage("AUTH_LOGIN")?>"  type="text"
                   name="USER_LOGIN" maxlength="50" value="" size="17" />

            <input  placeholder="<?=GetMessage("AUTH_PASSWORD")?>"  type="password"
                    name="USER_PASSWORD" maxlength="50" size="17" autocomplete="off" />

            <noindex>
                <a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow" class="hd_forgotpassword">
